...
impl<'a> AudioRingBuffer<'a> {
    ...
    pub fn write(&mut self, samples: &[f32]) -> usize {
        ...
        self.buffer[write_pos..write_pos + first_chunk]
    ...
    pub fn read(&mut self, samples: &mut [f32]) -> usize {
        ...
        samples[..first_chunk]
            .copy_from_slice(&self.buffer[read_pos..read_pos + first_chunk]);
        
        if first_chunk < to_read {
            let second_chunk = to_read - first_chunk;
            samples[first_chunk..to_read]
...
impl SharedMemory {
    ...
    pub fn midi_queue(&self) -> MidiEventQueue<'_> {
        ...
        MidiEventQueue::new(
            event_slice,
            &control.midi_write_pos,
            &control.midi_read_pos,
        )
    }
