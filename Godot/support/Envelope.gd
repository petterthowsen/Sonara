...
var min_attack: float = 0.001:
	set(value):
		min_attack = clamp(value, 0.001, 2.0)
		limits_changed.emit()
		emit_changed()
	get:
		return min_attack
...
var max_attack: float = 2.0:
	set(value):
		max_attack = clamp(value, 0.001, 2.0)
		limits_changed.emit()
		emit_changed()
	get:
		return max_attack
var min_decay: float = 0.001:
	set(value):
		min_decay = clamp(value, 0.001, 2.0)
		limits_changed.emit()
		emit_changed()
	get:
		return min_decay
...
var max_decay: float = 2.0:
	set(value):
		max_decay = clamp(value, 0.001, 2.0)
		limits_changed.emit()
		emit_changed()
	get:
		return max_decay
...
var min_release: float = 0.001:
	set(value):
		min_release = clamp(value, 0.001, 2.0)
		limits_changed.emit()
		emit_changed()
	get:
		return min_release
...
var max_release: float = 2.0:
	set(value):
		max_release = clamp(value, 0.001, 2.0)
		limits_changed.emit()
		emit_changed()
	get:
		return max_release
